"""Gera um mapa unico comparando rota urbana e rota de drone.

Este script nao recalcula rotas. Ele reutiliza os resultados ja existentes:
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Gera mapa comparativo de rota urbana e rota de drone.")
